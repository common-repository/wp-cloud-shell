<?php
/**
 * Plugin Name: WP CLoud Shell
 * Plugin URI: https://github.com/sam-cogan/wpcloudshell/tree/master/plugin
 * Version: 1.0
 * Author: Sam Cogan
 * Author URI: http://samcogan.com
 * Description: Generate a button in your blog posts to open Microsoft Azure Cloud Shell right next to your code samples
 * License: MIT
 */
...
add_filter( 'mce_buttons', array( &$this, 'add_wpcloudshell_button' ) );
...
function add_wpcloudshell_plugin( $plugin_array ) {
 ...
 function add_wpcloudshell_button( $buttons ) {
